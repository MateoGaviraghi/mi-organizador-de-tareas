  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans pb-20">
        ...
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
          ...
          <nav className="flex bg-slate-100 p-1 rounded-xl shrink-0">
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-bold uppercase tracking-wider transition-all ${activeTab === "backlog" ? "bg-white shadow-sm text-indigo-600" : "text-slate-500 hover:text-slate-800"}`}
            >
              <ListTodo size={16} />
              Buzón General
            </button>
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-bold uppercase tracking-wider transition-all ${activeTab === "planner" ? "bg-white shadow-sm text-indigo-600" : "text-slate-500 hover:text-slate-800"}`}
            >
              <Calendar size={16} />
              Planificador
            </button>
      ...
      <main className="max-w-3xl mx-auto px-3 py-4">
        <div className="flex items-center gap-4 mb-5 bg-slate-900 p-4 rounded-2xl text-white shadow-xl">
